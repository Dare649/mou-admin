...
export const actions = {
  ...
  async getApplications(context, data) {
    return await this.$axios.get('/api/cercord/get-applications?session='+data.session+'&cercord_application_number='+data.cercord_application_number+'&from_date='+data.from_date+'&to_date='+data.to_date+'&export='+data.export)
      .then(res =>{
        return res
      }).catch(err =>{
        return err
  ...
  async exportApplications(context, data) {
    return await this.$axios({
      method: 'get',
      url: 'api/cercord/get-applications?session='+data.session+'&cercord_application_number='+data.cercord_application_number+'&from_date='+data.from_date+'&to_date='+data.to_date+'&export='+data.export,
