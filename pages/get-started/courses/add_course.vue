            ...
            <div class="container sm-padding-10 p-t-20 p-l-10 p-r-10">
                <div class="card card-default">
                    <div class="card-header  separator">
                        <h3 class="text-primary no-margin pull-left sm-pull-reset">New Course</h3>
                        <div class="pull-right sm-pull-reset">
                            <a href="courses.php" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp; <strong>Back to Courses</strong></a>
                        </div>
                        ...
                        <form class="m-t-20" role="form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Semester" data-init-plugin="select2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label>Status</label>
                                        <select class="full-width" data-placeholder="Status" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Mark as Prerequisite Course" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Mark as Elective Course" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to MSP" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to POST UTME" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to DE 2nd Year" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to BSC" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to BSC (Direct Entry)" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to ND" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to Pre-Degree" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to MSC" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PHD" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PGD" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PGD MASTERS M.ED" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PGD MASTERS M.ENG" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PGD MASTERS MBA" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" data-placeholder="Applicable to PGD MASTERS M.A PHIL" data-init-plugin="select2">
                                            <option value="AK">Select</option>
                                            <option value="HI">Hawaii</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-info btn-lg btn-large fs-16 semi-bold btn-block"><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
