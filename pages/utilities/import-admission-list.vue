    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">Admission List Import</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header  separator">
              <h3 class="text-primary no-margin p-b-10">Admission List Import</h3>
            </div>
            <div class="card-body">
...
export default {
  ...
  methods: {
    importRecord() {
      ...
      this.$store.dispatch('utility/importUtilityAdmissionList', data)
        .then(res =>{
