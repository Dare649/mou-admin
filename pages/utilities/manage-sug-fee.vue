    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">Manage SUG Fee</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header  separator">
              <h3 class="text-primary no-margin p-b-10">Manage SUG Fee</h3>
            </div>
            <div class="card-body">
              <form class="p-4" @submit.prevent="submit">
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <label>Card No</label>
                    <input type="text" class="form-control" placeholder="SUG Card No" v-model="formData.sug_card" required>
                  </div>
                </div>
                <div class="row">
...
export default {
  ...
  methods: {
    submit() {
      ...
      this.$store.dispatch('student/submitSUG', this.formData)
        .then(res => {
