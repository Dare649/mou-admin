    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">DE results upload</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header  separator">
              <h3 class="text-primary no-margin p-b-10">DE results Upload</h3>
            </div>
            <div class="card-body">
...
export default {
  ...
  methods: {
    importDetails() {
      ...
      this.$store.dispatch('putme/importUtilityDEResults', data)
        .then(res =>{
