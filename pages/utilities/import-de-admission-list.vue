    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">DE Admission List Import</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header  separator">
              <h3 class="text-primary no-margin p-b-10">DE Admission List Import</h3>
            </div>
            <div class="card-body">
              <form class="p-4" @submit.prevent="importRecord">
                <div class="row">
                  <div class="form-group col-md-4">
                    ...
                    <select required class="form-control" v-model="formData.session_name">
                  ...
                  <div class="form-group col-md-4">
                    <label>Select Admission Category</label>
                    <select id="category" required class="form-control" v-model="formData.admission_category_id">
                      <option value="" disabled selected>Select your option</option>
...
export default {
  ...
  methods: {
    importRecord() {
      ...
      data.append('session_name', this.formData.session_name)
      data.append('admission_category_id', this.formData.admission_category_id)
      this.$store.dispatch('utility/importUtilityDeAdmissionList', data)
        .then(res =>{
    ...
    getAdmissionCategories() {
      ...
      this.$store.dispatch('utility/getAdmissionCategory')
        .then(res =>{
