<template>
  ...
  <div class="content sm-gutter">
    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item"><nuxt-link to="/academic-session/cec">CEC</nuxt-link></li>
    ...
    <div class="container sm-padding-10 p-t-20 p-l-0 p-r-0">
      <h3 class="text-primary m-t-30">CEC Options</h3>
      <hr />
                    ...
                    <div class="col-md-6">
                      <ValidationProvider rules="required" v-slot="{ errors }">
                        <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                          ...
                          <input type="text" v-model="formData.cec_session_name" class="form-control" required>
                    ...
                    <div class="col-md-6">
                      <ValidationProvider rules="required" v-slot="{ errors }">
                        <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                          ...
                          <input type="text" v-model="formData.cec_late_fees_due" class="form-control" required>
                          <small class="error">{{ errors[0] }}</small>
                        </div>
                      </ValidationProvider>
                    </div>
                    ...
                    <div class="col-md-6">
                      <ValidationProvider rules="required" v-slot="{ errors }">
                        <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                          ...
                          <input type="text" v-model="formData.cec_reg_admin_fees" class="form-control" required>
                          <small class="error">{{ errors[0] }}</small>
                        </div>
                      </ValidationProvider>
                    </div>
...
export default {
  ...
  methods: {
    async submitForm() {
      ...
      this.formData.admin_fees_instruction = this.adminFeesInstruction.getContent();
      ...
      if(!form1Status || !form2Status || !form3Status) {
        $('#submitForm').attr('disabled', false).html('<i class="fa fa-spin fa-spinner"></i> Submit');
      ...
      if(this.id === 'new') {
        ...
        this.$axios.post('api/cec-sessions', this.formData).then(res => {
          ...
          if(res.data.status) {
            ...
            this.$router.push(decodeURIComponent(this.$route.query.redirect || "/academic-session/cec"))
          } else {
        ...
        this.$axios.put('api/cec-sessions/' + this.id, this.formData).then(res => {
          $('#submitForm').attr('disabled', false).html('Finish');
          if(res.data.status) {
            // reset forms
            this.$refs.step1.reset();
    ...
    getCecSession(id) {
      this.$axios.get(`api/cec-sessions/${id}`).then(res => {
        ...
        this.formData = {
          ...
          cec_late_fees_due: session.cec_late_fees_due,
          cec_registration_fee: session.cec_registration_fee,
          ...
          cec_reg_admin_fees: session.cec_reg_admin_fees,
        ...
        this.adminFeesInstruction.setContent(session.admin_fees_instruction);
  ...
  mounted() {
    ...
    if (this.id !== 'new') {
      this.getCecSession(this.id);
    }
    if(this.formData) {
      this.adminFeesInstruction      = createEditor('#admin_fees_instruction', this.config)
