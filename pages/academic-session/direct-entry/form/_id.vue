    ...
    <!-- START PAGE CONTENT -->
        <div class="content sm-gutter">
            ...
            <div class="bg-white">
                <div class="container p-l-5">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item"><nuxt-link to="/academic-session/direct-entry">Direct Entry</nuxt-link></li>
            ...
            <div class="container sm-padding-10 p-t-20 p-l-0 p-r-0">
                <h3 class="text-primary m-t-30">Direct Entry Options</h3>
                <hr />
                                            ...
                                            <div class="col-md-6">
                                                <ValidationProvider rules="required" v-slot="{ errors }">
                                                    <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                                                        <label>DE Exam Name</label>
                                                        <input type="text" v-model="formData.de_session_name" class="form-control" required>
                                        ...
                                        <div class="col-md-6">
                                          <ValidationProvider rules="required" v-slot="{ errors }">
                                            <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                                              ...
                                              <input type="text" v-model="formData.de_late_fees_due" class="form-control" required>
                                              <small class="error">{{ errors[0] }}</small>
                                            </div>
                                          </ValidationProvider>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                          <ValidationProvider rules="required" v-slot="{ errors }">
                                            <div class="form-group form-group-default required" :class="{'has-error' : errors.length}">
                                              ...
                                              <input type="text" v-model="formData.de_reg_admin_fees" class="form-control" required>
                                              <small class="error">{{ errors[0] }}</small>
                                            </div>
                                          </ValidationProvider>
                                        </div>
    ...
    methods: {
        async submitForm() {
            ...
            if(this.id === 'new') {
                ...
                this.$axios.put('api/de-sessions/' + this.id, this.formData).then(res => {
                    $('#submitForm').attr('disabled', false).html('Finish');
                    if(res.data.status) {
                        // reset forms
                        this.$refs.step1.reset();
