    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item"><nuxt-link to="/academic-session/direct-entry">Academic Session</nuxt-link></li>
...
<script>
  ...
  export default {
    ...
    methods: {
      downloadSampleCSV() {
        this.$axios.get('api/de-sessions/student-union-dues/sample').then(res => {
          if (res.data.success) {
      ...
      deleteRecord(e, id) {
        ...
        this.$swal({
          ...
          if (result.value) {
            this.$axios.delete(`api/de-sessions/student-union-dues/${id}`).then(res => {
              if (res.data.status) {
