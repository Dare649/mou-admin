    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">MBS Admission List</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
            ...
            <div class="col-md-10 offset-md-1">
              ...
              <div class="card card-transparent text-center">
                <div class="card-header ">
                  <div class="card-title">MBS STUDENTS ONLY UPLOAD</div>
                </div>
                <div class="card-body">
                  <h6 class="semi-bold">1. Admin will get the sample excel file by clicking the "Download Sample Excel" button.</h6>
                  <h6 class="semi-bold">2. Fill the excel sheet appropriately, select the necessary options and upload by clicking on the "IMPORT RECORD" button in the "Upload MBS Admission List" section.</h6>
                </div>
              </div>
              <!-- END card -->
            </div>
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header  separator">
              <h3 class="text-primary no-margin p-b-10">Upload MBS Admission List</h3>
            </div>
            <div class="card-body">
  ...
  methods: {
    importFile() {
      if(confirm('Are you sure you want to import this file?')) {
        ...
        this.$store.dispatch('mbs-admission/importMbsAdmissionList', data)
          .then(res => {
    ...
    downloadSampleFile() {
      ...
      this.$store.dispatch('mbs-admission/downloadSampleFile')
        .then(res =>{
