                                    ...
                                    <tr v-else v-for="user in users" :key="user.id">
                                        ...
                                        <td>
                                          <div class="btn-group">
                                            ...
                                            <a href="#view_jamb_result" @click="showDetails(user.registration_number)" class="btn btn-default btn-sm" role="button" data-toggle="modal"><i class="fa fa-eye"></i></a>
                                            ...
                                            <a href="javascript:;" @click="markForApproval(user.registration_number)" title="Mark for departmental approval" class="btn btn-default btn-sm" role="button"><i class="fa fa-map-marker"></i></a>
