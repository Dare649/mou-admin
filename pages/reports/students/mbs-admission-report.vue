    ...
    <div class="bg-white">
      <div class="container p-l-5">
        <ol class="breadcrumb breadcrumb-alt">
          ...
          <li class="breadcrumb-item active">MBS Admissions Report</li>
        </ol>
      </div>
    </div>
    <!-- END BREADCRUMBS -->
    ...
    <div class="container sm-padding-10 p-t-20 p-l-0 p-r-0">
      <div class="card card-default">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <label>MBS Application No:</label>
              <input type="text" v-model="formData.registration_number" class="form-control" placeholder="Cercord Application Number" />
            </div>
            <div class="col-md-2">
      ...
      <div class="card card-default">
        <div class="card-header separator">
          <h3 class="text-primary no-margin pull-left sm-pull-reset">MBS Admissions List Report</h3>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-condensed" id="basicTable">
              ...
              <tr v-if="!loading" v-for="student in students" :key="student.id">
                <td>{{ student.mbs_application_number }}</td>
                <td>{{ student.details.first_name }} {{ student.details.last_name }}</td>
                <td>{{ student.details.gender }}</td>
                <td>{{ student.program.name }}</td>
                <td>
                  <div class="btn-group">
                    <button type="button" @click="markForApproval(student.mbs_application_number)" v-if="student.marked_for_dept_clearance == 0" title="Mark for departmental approval" class="btn btn-default btn-sm" role="button"><i class="fa fa-map-marker"></i></button>
...
export default {
  ...
  methods: {
    ...
    searchRecord(page) {
      ...
      this.$store.dispatch('mbs-admission/getMbsAdmissionList', this.formData)
        .then(res =>{
    ...
    exportRecord() {
      ...
      this.$store.dispatch('mbs-admission/exportMbsAdmissionList', this.formData)
        .then(res =>{
          ...
          fileLink.setAttribute('download', 'mbs-admission-list-report.xlsx');
